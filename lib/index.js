...
module.exports = function (app) {
    app.on('pull_request.labeled', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var labels, config, approveLabels, _i, _a, label, _b, labels_1, label, checkLabel, number, _c, owner, repo, result;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    _d.label = 2;
                case 2:
                    if (!(_b < labels_1.length)) return [3 /*break*/, 5];
                    label = labels_1[_b];
                    app.log.debug('Process label: ' + label.name);
                    checkLabel = label.name.toUpperCase();
                    if (!approveLabels.includes(checkLabel)) return [3 /*break*/, 4];
